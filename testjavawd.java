    	...
    	String code=request.getParameter("code");
 		...
 		if(validId==true){
 			...
 			if(validCode==true){
 				...
 				String query5="select amount from history where code='"+code+"';";
 		    	...
 		    	//rs=qu.executeQuery(query5);
 		    	
 		    	while(rs.next()){
 		    	
 		    		
 		    	 amt=Double.parseDouble(rs.getString(1));
 				...
 				JOptionPane.showMessageDialog(null, "Successfully withdraw "+amt);
				response.sendRedirect("loadingbar.jsp");
 			} //code valid
 			else if(alreadyWith){
